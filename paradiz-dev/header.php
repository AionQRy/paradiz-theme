        ...
        <header id="masthead" class="site-header _heading <?php echo $headerClass; ?>"
            ...
            <div class="s-container">
                ...
                <div class="action-left">
                    <?php paradiz_header_action($GLOBALS['s_left_area'], $GLOBALS['s_left_area_phone'], $GLOBALS['s_left_area_custom'] ); ?>
                </div>

                <div class="action-right">
                    <?php paradiz_header_action($GLOBALS['s_right_area'], $GLOBALS['s_right_area_phone'], $GLOBALS['s_right_area_custom'] ); ?>
                </div>
                    ...
                    <?php
                        ...
                        if ( ! empty( $GLOBALS['s_header_action'] ) ) {
                            foreach ( $GLOBALS['s_header_action'] as $action ) {
                                switch ($action) {
                                    case 'search':
                                        echo '<a class="site-search s-modal-trigger m-user" onclick="return false;" data-popup-trigger="site-search"><i class="flaticon-magnifying-glass"></i></a>';
                                        break;
                                    case 'cart':
                                        $cart_url = '';
                                        ...
                                        echo '<a class="site-cart" href="' .  $cart_url . '" title="' . __( 'View your shopping cart', 'paradiz' ) . '">';
                                        echo '<i class="flaticon-' . $GLOBALS['s_cart_icon'] . '"><b id="cart-count" class="hide"></b></i>';
                                        echo '</a>';
                                        break;
                                    case 'my-account':
                                        paradiz_member_menu();
